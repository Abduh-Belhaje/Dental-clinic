    ...
    <div 
      ...
      <div className="py-8 font-playfair flex flex-col items-center md:w-3/4 w-full">
          <div className="py-1 flex items-end md:justify-center justify-evenly w-full">
            <span className="lg:text-8xl md:text-6xl text-2xl font-bold ">Your dream</span>
            <Image src={Smile} className="rounded-3xl lg:h-20 lg:w-40 md:h-12 md:w-28 h-8 w-20 md:mx-5" alt=""/>
            </div>
          <div className="py-1 flex items-end md:justify-center justify-evenly  w-full">
          <span className="lg:text-8xl md:text-6xl text-2xl font-bold">smile</span>
          <Image src={Smile2} className="rounded-3xl lg:h-20 lg:w-40 md:h-12 md:w-28 h-8 w-20 md:mx-5" alt=""/> 
            <span className="lg:text-8xl md:text-6xl text-2xl font-bold">is our</span>
            </div>
          <div className="flex md:items-end items-center md:justify-center justify-evenly   w-full">
            ...
            <span className="lg:text-8xl md:text-6xl text-2xl font-bold py-1">Care</span> 
            <button className="bg-primary lg:text-lg text-sm text-white md:py-3 py-1 lg:px-10 px-5 rounded mx-10">Book Now !</button> 
            </div>
      </div>
